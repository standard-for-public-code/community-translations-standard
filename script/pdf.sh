...
weasyprint --presentational-hints \
	"http://localhost:$JEKYLL_PDF_PORT/nl/standard-print.html" \
...
echo
weasyprint --presentational-hints \
	"http://localhost:$JEKYLL_PDF_PORT/nl/print-cover.html" \
	standaard-cover-$VERSION.pdf
ls -l	standaard-cover-$VERSION.pdf
