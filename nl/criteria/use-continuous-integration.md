...
- Alle functionaliteit in de [broncode](/nl/glossary.html#broncode) MOET geautomatiseerd worden getest.
...
- Het testen van [beleid](/nl/glossary.html#beleid) en documentatie op consistentie met de broncode en vice versa is OPTIONEEL.
