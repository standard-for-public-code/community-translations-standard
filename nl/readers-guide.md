...
* ZOU MOETEN: sterke wens, tenzij er een valide reden is er in een specifiek geval vanaf te wijken
...
De Standaard voor Publieke Code is niet bedoeld voor individuele implementaties van een codebase. Dit betekent dat de Standaard voor Publieke Code niet vertelt welke lokale technische infrastructuur of het juridische kaders er nodig zijn voor implementatie van een codebase.

Hoewel de Standaard voor Publieke Code verwijst naar verschillende standaarden en er aanzienlijke overlappingen zijn met andere standaarden, richt de Standaard voor Publieke Code zich specifiek op de samenwerking. Daarom is het niet de bedoeling om kwaliteitsstandaarden te vervangen, zoals de ISO 25000-serie, of standaarden die gericht zijn op beveiliging, zoals de OpenSSF Best Practices Badge, maar om er een goede synergie mee te creëren.
